...
const SelectedNews: EcGridItemProps[] = [
    ...
    { title: "新闻媒体:ChinaJoy新闻专区上线！", desc: "EaseCation 作为全国最大规模电子数码展会之一 ChinaJoy 的2020-2024年官方支持合作媒体现已推出ChinaJoy新闻专区第一时间发布相关资讯！", image: newsImage2,url:"/category/chinajoy-zhuan1-qu1",urlEng: "/en/category/chinajoy-zhuan1-qu1"},
